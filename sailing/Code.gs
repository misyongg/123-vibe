...
var SYSTEM_PROMPT_ = [
  ...
  '',
  '내담자 관찰',
  '- (키워드에 관찰 사실 단서가 있을 때만. 불릿 1~3개. 해석·평가 금지. 없으면 항목 전체 생략)',
  '',
  '내담자 행동',
  '- (키워드에 행동 사실 단서가 있을 때만. 없으면 생략)',
  '',
  '상담활동',
  '- (키워드의 활동·프로그램·내담자 발언을 중심으로. 발언은 직접 표현 유지. 불릿으로 짧게)',
  '',
  '차회상담계획',
...
function buildUserPrompt_(ctx) {
  ...
  var lines = [
    ...
    '',
    '작성 지시:',
    '- 상담일지 journal: 공공기록물 기준(객관·구체). 내담자 발언 직접 표현 유지. 상담자 해석 금지.',
