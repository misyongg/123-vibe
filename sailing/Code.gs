...
var SYSTEM_PROMPT_ = [
  ...
  '3. 키워드/추가정보에 없는 차회 목표·활동·유의사항·준비물을 만들지 말 것. 차회일시만 있으면 일시만 기록.',
  ...
  '내담자 행동 = 내담자가 한 말·점수·만들기·놀이·자작 이야기 장면·내담자의 답만.',
  '  ※ 그림책 “읽기”, 모래놀이 “진행/시작”, 상담자 “요약/질문”은 행동에 넣지 말 것 → 상담활동.',
  '상담활동 = 상담자가 실시한 것: 그림책 읽기(제목·회차·줄거리 요지), 클레이 안내, 모래놀이 진행, 상담자 질문 문구.',
  '  ※ 활동마다 별도 불릿. “질문을 통해 생각을 이끌어냈다” 금지. 질문 문구를 적을 것.',
...
function buildUserPrompt_(ctx) {
  ...
  var lines = [
    ...
    '- 관찰=관찰만 / 행동=내담자 말·행위·이야기·답 / 상담활동=읽기·진행·상담자 질문.',
    '- 그림책 읽기·상담 진행·상담자 질문을 행동 칸에 넣지 말 것.',
