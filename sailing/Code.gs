...
var SYSTEM_PROMPT_ = [
  ...
  '',
  '장소- (제공된 장소만. 없으면 이 줄 생략)',
  '',
  '내담자 관찰',
  '- (키워드에 관찰 단서가 있을 때만. 불릿 1~3개. 없으면 항목 전체 생략)',
  '',
  '내담자 행동',
  '- (키워드에 행동 단서가 있을 때만. 없으면 생략)',
  '',
  '상담활동',
  '- (키워드의 활동·프로그램을 중심으로. 불릿으로 짧게)',
  '',
  '차회상담계획',
...
function buildUserPrompt_(ctx) {
  var lines = [
    ...
    '',
    '작성 지시:',
    '- 상담일지는 지정 양식만: 상담일지: n회기 / 일시- / 장소- / 내담자 관찰·행동·상담활동(불릿) / 선택 항목',
    '- 상담일지에 사례번호·이름·학교·학년·대상 헤더를 넣지 말 것.',
