...
**바로가기:** [Sailing 웹앱 열기](https://script.google.com/macros/s/AKfycby5cv4ZgaWu2fQHDQXNqx3Ln-gnGvMVPjAegXcpDvehA1dPVlIO_ieST1VlC70QkAMV/exec)
...
3. 키워드 메모 입력
4. (선택) 미리보기에서 수정
5. **출력** → 모은 키워드로 AI 작성 후, 해당 노션 **기존 예약 페이지**에  
   `상담일지: n회기` / `상담자 메모: n회기` **토글**로 반영

- **저장** = 키워드 누적만 (노션 미반영)
- **출력** = AI 작성 + 노션 반영
키워드는 **저장**으로 여러 번 모은 뒤, 마지막에 **출력** 한 번만 누르면 됩니다.
