...
function buildUserPrompt_(ctx) {
  ...
  var lines = [
    ...
    '',
    '작성 지시:',
    '- journal: 사실만. 「상담자 견해」 금지. 관찰/행동(이야기 단계)/상담활동.',
    '- 장소- 는 「장소(상담일지용·일정 구분 값)」만. 토글 제목 중복 금지.',
    '- memo: 「이름」 금지. 「- 사례번호:」만.',
    '- memo 「상담활동 요약」: 구체 사실·발언·점수·장면. 뭉개기 금지.',
    '- memo 「상담자 견해」 필수: 아래 5줄을 모두 내용 있게 채울 것.',
    '  - 정서 상태: …',
    '  - 관계 특성: …',
    '  - 위험요인: …',
    '  - 보호요인: …',
    '  - 현재 상담 초점: …',
    '- 위 5항목은 키워드의 감정·관계·증상·지지·활동·발언을 근거로 상담자 관점에서 1~2문장씩. 빈 “-” 금지.',
    '- memo 「차회 계획」/차회일시: 키워드에 차회 정보가 있을 때만. 없으면 생략.',
